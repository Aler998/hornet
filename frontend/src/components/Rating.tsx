...
function Rating({ voto, placeItems = "place-items-end", dimensions = "w-6 h-6" }: { voto: number, placeItems?: string, dimensions?: string }) {
    ...
    const highlitedStar = <span>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
            fill="currentColor" className={svgClasses}>
