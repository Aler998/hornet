...
export const galleryNav = {
    label: "gallery",
    nav: <span className="mx-2 flex items-center font-oswald font-semibold text-lg cursor-pointer"><IoMdImages className="mr-2" /> Immagini</span>
}
    ...
    return trip.images ? (
        ...
        <ImageGallery
            ...
            items={trip.images.map((image) => ({
                original: import.meta.env.VITE_ASSETS_URL + image.folder + "/hd/" + image.filename,
                thumbnail: import.meta.env.VITE_ASSETS_URL + image.folder + "/thumbnail/" + image.filename,
